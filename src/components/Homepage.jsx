  ...
  return (
    ...
    >
      ...
      <div className="flex overflow-hidden relative justify-center items-center w-full ">
        <div className="flex relative flex-col gap-8 items-center w-[1244px] z-[1] max-md:px-4 max-md:py-2 max-md:w-full max-md:mt-10">
          ...
          <div className="flex flex-col gap-2 sm:gap-3 items-center text-center mt-10 sm:mt-10">
            <h1 className="mb-2 sm:mb-3 text-4xl sm:text-5xl md:text-6xl font-bold w-full max-w-[897px] px-4">
              <span className="text-white font-bold text-4xl sm:text-5xl md:text-[65px] leading-tight sm:leading-snug tracking-normal">
                Instantly Boost{" "}
              </span>
              <span class="text-[#FFFFFF1A] text-opacity-10 font-bold text-4xl sm:text-5xl md:text-[65px] leading-tight sm:leading-snug tracking-normal [-webkit-text-stroke:0.5px_white]">
                Site Speed
              </span>
              ...
              <span className="text-[#FFFFFF1A] text-opacity-10 font-bold text-4xl sm:text-5xl md:text-[65px] leading-tight sm:leading-snug tracking-normal [-webkit-text-stroke:0.5px_white]">
                Automate
              </span>
              <span className="text-white font-bold text-4xl sm:text-5xl md:text-[65px] leading-tight sm:leading-snug tracking-normal">
                {" "}
            ...
            <p className="text-base sm:text-lg text-[#F7F8FA] font-normal leading-relaxed tracking-normal px-4">
